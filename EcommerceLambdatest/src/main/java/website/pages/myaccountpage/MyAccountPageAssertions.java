...
public class MyAccountPageAssertions extends BaseAssertions<MyAccountPageMap> {
    ...
    public void assertAccountInformationIsSuccessfullyUpdated() {
        var successfullyUpdatedAccountInfoMessage = formatMessage(ERROR_MESSAGE_PASSWORD, SUCCESSFULLY_ACCOUNT_INFORMATION_UPDATED_MESSAGE, elementsT().successfullyMessage().getText());
    ...
    public void assertPasswordSuccessfullyChanged() {
        var successfullyChangePasswordMessage = formatMessage(ERROR_MESSAGE_PASSWORD, SUCCESSFULLY_PASSWORD_MESSAGE, elementsT().successfullyMessage().getText());
    ...
    public void assertSuccessfullyPurchaseGiftCertificate() {
        var successfullyPurchaseGiftCertificateMessage = formatMessage(ERROR_MESSAGE_PASSWORD, elementsT().successfullyPurchaseCertificate().getText(), SUCCESSFULLY_PURCHASE_VOUCHER_MESSAGE);
    ...
    public void assertSuccessfullyAddedNewAddress() {
        var successfullyChangePasswordMessage = formatMessage(ERROR_MESSAGE_ADDRESS, SUCCESSFULLY_ADDED_NEW_ADDRESS_MESSAGE, elementsT().successfullyMessage().getText());
    ...
    public void assertCustomerNameCorrect(PersonalInformation user) {
        ...
        var customerNameMessage = formatMessage(ERROR_MESSAGE_ADDRESS, actualFullName, expectedFullName);
    ...
    public void assertGiftCertificateRemoved(PurchaseGiftCertificate giftName) {
        ...
        var giftCertificateMessage = formatMessage(errorMessageRemovedProduct, String.valueOf(elementsT().removedProduct(expectedMessage)), expectedMessage);
